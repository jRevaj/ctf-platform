...
from ctf.views import home, ChallengesView, scoreboard_view, teams_view, team_detail_view, register_view, login_view, \
    logout_view, settings_view, team_management_view, create_team_view, join_team_view, remove_team_member_view, \
    regenerate_team_key_view, FlagSubmissionView, StartDeploymentView, DeploymentStatusView
