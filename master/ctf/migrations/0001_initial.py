    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container_inactivity_timeout', models.PositiveIntegerField(default=30, help_text='Number of minutes to wait before stopping an inactive container')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            ...
            name='blue_team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='blue_containers', to='ctf.team'),
        ),
        migrations.AddField(
            model_name='gamecontainer',
            name='red_team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='red_containers', to='ctf.team'),
        ),
        migrations.CreateModel(
            name='Flag',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('blue', 'Blue'), ('red', 'Red')], max_length=10)),
        ...
        migrations.AddField(
            model_name='user',
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='users', to='ctf.team'),
        ),
        migrations.CreateModel(
            name='TeamAssignment',
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='ctf.team')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['container', 'is_active'], name='ctf_contain_contain_ce89f2_idx'),
        ),
        migrations.AddIndex(
